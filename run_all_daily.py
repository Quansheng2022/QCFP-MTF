...
def run_scripts():
    """依次运行四个 Python 脚本，使用虚拟环境中的 Python"""
    python_exe = get_python_interpreter()

    scripts = [
        [python_exe, "run_Daily_TA_workflow.py"],
        [python_exe, "run_HK_macro_dashboard_workflow.py"],
        [python_exe, "run_QCFP_MTF_workflow.py"],
        [python_exe, r"Code_Prompt\Gen_Prompt_Daily.py"]   # 原始字符串避免转义
    ]
