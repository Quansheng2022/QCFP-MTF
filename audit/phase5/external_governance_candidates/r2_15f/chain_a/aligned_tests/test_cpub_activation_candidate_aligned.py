...
SERVICE_SRC = (PROJECT_ROOT / "audit/phase5/external_governance_candidates/r2_15f/canonical_publication_r2_15f_candidate.py").read_text(
    encoding="utf-8")


def _service_module():
    module = types.ModuleType("cpub_candidate_service")
    module.__file__ = str(PROJECT_ROOT / "audit/phase5/external_governance_candidates/r2_15f/canonical_publication_r2_15f_candidate.py")
    exec(compile(SERVICE_SRC, str(PROJECT_ROOT / "audit/phase5/external_governance_candidates/r2_15f/canonical_publication_r2_15f_candidate.py"),
...
def test_a02_missing_activation_artifact_fails_before_evaluate():
    ...
    module.FIXED_ARTIFACTS = {
        "human_acceptance": PROJECT_ROOT /
        "audit/phase5/p5_gov_reopen_cpub_human_acceptance.json",
        "activation": PROJECT_ROOT /
        "audit/phase5/p5_gov_reopen_cpub_activation.json",
        "candidate_package": PROJECT_ROOT /
        "audit/phase5/cpub_candidate/10_candidate_package.json",
        "candidate_manifest": PROJECT_ROOT /
        "audit/phase5/cpub_candidate/09_candidate_manifest.json",
        "governance_baseline": PROJECT_ROOT /
...
def test_valid_complete_authority_chain_passes(tmp_path, monkeypatch):
    ...
    baseline_bytes = finalizer.finalize_governance_baseline(
        candidate_baseline_bytes=(PROJECT_ROOT /
            "audit/phase5/external_governance_candidates/r2_15f/chain_a/predecessor_baseline_163ddd73.json").read_bytes(),
        candidate_package_bytes=package_bytes,
        human_acceptance_bytes=acceptance,
