...
"""
Generate_hk_hist_weekly_kline_Dictionary.py
生成 hk_hist_weekly_kline 表的数据字典

功能：
1. 读取 SQLite 数据库中的 hk_hist_weekly_kline 表结构
...
class Config:
    ...
    # 输出文件名
    JSON_FILENAME = "hk_hist_weekly_kline_dictionary.json"
    MARKDOWN_FILENAME = "hk_hist_weekly_kline_dictionary.md"
    EXCEL_FILENAME = "hk_hist_weekly_kline_dictionary.xlsx"
...
class DataDictionaryGenerator:
    ...
    def _get_field_description(self, field_name: str) -> str:
        ...
        descriptions = {
            ...
            'macd_signal': 'MACD Signal线（慢线）',
            'macd_histogram': 'MACD柱状图（DIF - Signal）'
        }
...
def main():
    """主函数"""
    print("=" * 60)
    print("生成 hk_hist_weekly_kline 数据字典")
    print("=" * 60)
